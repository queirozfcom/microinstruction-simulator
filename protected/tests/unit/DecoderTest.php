...
class DecoderTest extends CDbTestCase{
    ...
    public function test_constant_no_indirection2(){
        ...
        $inst = new Instruction('mov','constant',false,'r1',false);
...
//        $method = self::getMethod('decodeMovInstruction');
//        
//        $inst = new Instruction('mov','constant',false,'constant',true);
//        
//        $mp = $method->invoke($obj,$inst);
//        
...
//    }
    public function testDecodeMovToMar(){
        ...
        $inst = new Instruction('mov','r3',false,'mar',false);
